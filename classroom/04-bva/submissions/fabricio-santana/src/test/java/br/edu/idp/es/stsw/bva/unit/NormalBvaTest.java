...
class NormalBvaTest {
    ...
    @DisplayName("Autoriza a missão ao avaliar individualmente cada condição nos limites operacionais")
    void shouldAuthorizeMissionWhenEachConditionIsWithinOperationalLimits(
            int battery,
            int wind,
            int payloadWeight,
