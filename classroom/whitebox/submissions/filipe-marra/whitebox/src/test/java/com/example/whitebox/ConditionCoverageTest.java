...
public class ConditionCoverageTest {
    ...
    @Test
    void shouldMakeCouponValidTrueAndPurchaseAmountGreaterOrEqual200True() {
        int discount = calculator.calculateDiscount(false, 200, true, false);
        assertEquals(25, discount);
    }

    @Test
    void shouldMakeCouponValidFalse() {
        int discount = calculator.calculateDiscount(false, 200, false, false);
        assertEquals(10, discount);
    }

    @Test
    void shouldMakePurchaseAmountGreaterOrEqual200FalseInsideCouponDecision() {
    ...
    @Test
    void shouldMakeBlackFridayFalseAndPremiumTrueAndPurchaseAmountGreaterOrEqual300True() {
    ...
    @Test
    void shouldMakePurchaseAmountGreaterOrEqual300FalseInsideLastDecision() {
